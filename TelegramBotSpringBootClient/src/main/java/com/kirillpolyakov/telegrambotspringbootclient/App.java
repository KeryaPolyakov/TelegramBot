package com.kirillpolyakov.telegrambotspringbootclient;

import com.kirillpolyakov.telegrambotspringbootclient.controller.ControllerData;
...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        Scene scene = new Scene(fxmlLoader.load(), 412, 341);
